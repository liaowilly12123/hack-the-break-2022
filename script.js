...
const java_btn = document.querySelector(".java_btn button");
const system_btn = document.querySelector(".system_btn button");
const web_btn = document.querySelector(".web_btn button");
